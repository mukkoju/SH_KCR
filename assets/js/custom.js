...
var ls, layoutSwiper = {
  ...
  menuDown: function () {
    TweenMax.to(ls.menuPannel, 0.5, {top: "-350px", ease: Power4.easeOut});
  },
  menuIn: function () {
    TweenMax.to(ls.menuPannel, 0.5, {top: "0", ease: Power4.easeOut});
  },
...
var tcs, teamCarousel = {
  ...
  init: function () {
    ...
    tcs.imagesContainer.children().each(function (i, item) {
      tcs.imagesContainer.prepend(item)
    });
