    ...
    if ($("html").hasClass("mobile")) $("html").hasClass("mobile") && ($("body").addClass("bms-mobile"), $("body.bms-mobile").css("min-height", "100%"), gallery_slider = $(".images-list-in-modal").bxSlider({}), $(function() {
        ...
        $(".timeline-item").each(function(f) {
            $(this).on("click", function() {
                ...
                $("#ti-1").hasClass("active") ? ($(".circular-timeline").css("background-color", "#C43A2F"), $(".timeline-item").css("background-color", "#C43A2F")) : $("#ti-2").hasClass("active") ? ($(".circular-timeline").css("background-color", "#78CFFF"), $(".timeline-item").css("background-color",
                    "#78CFFF")) : $("#ti-3").hasClass("active") ? ($(".circular-timeline").css("background-color", "#FDBB50"), $(".timeline-item").css("background-color", "#FDBB50")) : $("#ti-4").hasClass("active") ? ($(".circular-timeline").css("background-color", "#F26F70"), $(".timeline-item").css("background-color", "#F26F70")) : $("#ti-5").hasClass("active") ? ($(".circular-timeline").css("background-color", "#81BC5D"), $(".timeline-item").css("background-color", "#81BC5D")) : $("#ti-6").hasClass("active") && ($(".circular-timeline").css("background-color",
                    "#8D7AB8"), $(".timeline-item").css("background-color", "#8D7AB8"))
            })
        });
